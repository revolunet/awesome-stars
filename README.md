...
- [betagouv/dora-pdf](https://github.com/betagouv/dora-pdf) - Simple Node.js service to generate a PDF from an URL via Puppeteer
...
- [obogo/ux-angularjs-datagrid](https://github.com/obogo/ux-angularjs-datagrid) - The Angular Datagrid. Highly optimized AngularJS datagrid, works great on mobile. Easily modify and add your own behavior with addons! Now your ng-repeat doesn't have to bog down your app when you hav
...
- [Meeovi/CollaborrateApp](https://github.com/Meeovi/CollaborrateApp) - Powerful headless customer relationship framework that can be used to build relations with customers, create and manage projects, lists, tickets, and more.
...
- [Fredkiss3/gh-next](https://github.com/Fredkiss3/gh-next) - A minimal Github clone built on nextjs app router and hosted on vercel
...
- [argos-ci/argos](https://github.com/argos-ci/argos) - Argos is a visual testing solution that fits in your workflow to avoid visual regression. Takes screenshots on each commit and be notified if something changes.
