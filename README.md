...
- [kubefarm/kubefarm](https://github.com/kubefarm/kubefarm) - Automated Kubernetes deployment and the PXE-bootable servers farm
...
- [italia/design-react-kit](https://github.com/italia/design-react-kit) - Versione in fase di sviluppo del nuovo toolkit React conforme alle linee guida di design per i servizi web della PA. 5.0.0 prevista per Febbraio 2024.
