...
- [mic159/NeoFire](https://github.com/mic159/NeoFire) - A fire animation using NeoMatrix on some WS2812 NeoPixels.
...
- [lvgl/lv_web_emscripten](https://github.com/lvgl/lv_web_emscripten) - LVGL ported to Emscripten to be converted to JavaScript
...
- [asg017/sqlite-lembed](https://github.com/asg017/sqlite-lembed) - A SQLite extension for generating text embeddings from GGUF models using llama.cpp
...
- [please-openit/pam-oauth2](https://github.com/please-openit/pam-oauth2) - OAuth2 pam module
...
- [AxaFrance/SlimFaas](https://github.com/AxaFrance/SlimFaas) - SlimFaas : The slimest and simplest Function As A Service
- [msub2/silk-brush-2021](https://github.com/msub2/silk-brush-2021) - An effort to port Tilt Brush to WebXR.
...
- [essej/sooperlooper](https://github.com/essej/sooperlooper) - 
...
- [skovaka/UNCALLED](https://github.com/skovaka/UNCALLED) - Raw nanopore signal mapper that enables real-time targeted sequencing
...
- [Makuna/Task](https://github.com/Makuna/Task) - Arduino Nonpreemptive multitasking library.  Please refer to the Wiki for more details.  Please use the GitHub Discussions to ask questions as the GitHub Issues feature is used for bug tracking.
...
- [trberrido/wp-dsfr](https://github.com/trberrido/wp-dsfr) - Design System WordPress Gutenberg FSE
...
- [davebalmer/jo](https://github.com/davebalmer/jo) - Jo (0.5.0) is a thin (~16K) candy shell for making HTML5 apps. Jo works with: PhoneGap, Chrome, Safari, Opera, FireFox, iOS, Android, BlackBerry 10, Tizen, & Windows Phone 8+. Features include skinnab
...
- [wspringer/angular-pouchdb](https://github.com/wspringer/angular-pouchdb) - Angular wrapper for PouchDB, making sure that callbacks are called within $rootScope.$apply(), and using $q promises instead of callbacks. On top of that, it supports an `ng-repeat`-alike directive fo
...
- [sea-monkeys/amphipod](https://github.com/sea-monkeys/amphipod) - 
...
- [Qovery/migration-db](https://github.com/Qovery/migration-db) - MigrationDB is a database migration tool that enables streaming data transfers between databases of the same type
- [acidvegas/elastop](https://github.com/acidvegas/elastop) - HTOP for Elasticsearch
- [pulumiverse/pulumi-scaleway](https://github.com/pulumiverse/pulumi-scaleway) - Pulumi provider for Scaleway
- [kubernetes-sigs/kubebuilder](https://github.com/kubernetes-sigs/kubebuilder) - Kubebuilder - SDK for building Kubernetes APIs using CRDs
- [thomiceli/opengist](https://github.com/thomiceli/opengist) - Self-hosted pastebin powered by Git, open-source alternative to Github Gist.
- [faroedev/faroe](https://github.com/faroedev/faroe) - A modular backend for email and password authentication
...
- [mattermost/mattermost-plugin-github](https://github.com/mattermost/mattermost-plugin-github) - GitHub plugin for Mattermost
- [nev7n/wait_for_response](https://github.com/nev7n/wait_for_response) - Github action to wait for a response
...
- [dirien/no-yaml](https://github.com/dirien/no-yaml) - No YAML deployments to K8s
- [FairwindsOps/goldilocks](https://github.com/FairwindsOps/goldilocks) - Get your resource requests "Just Right"
- [mittwald/kubernetes-secret-generator](https://github.com/mittwald/kubernetes-secret-generator) - Kubernetes controller for automatically generating and updating secrets
- [factorysh/microdensity](https://github.com/factorysh/microdensity) - trigger async analysis from your Gitlab CI and expose badges
...
- [mrusme/lemon](https://github.com/mrusme/lemon) - Lemon is a notification proxy that supports D-Bus, as well as the Pimoroni Raspberry Pi Unicorn Hat HD, allowing you to build a cheap, open-source alternative to LaMetric.
...
- [fiatjaf/summadb](https://github.com/fiatjaf/summadb) - A hierarchical database that stores computed values.
...
- [openfun/kubic](https://github.com/openfun/kubic) - A Kubernetes deployment as code to OVH or Scaleway, with Prometheus, ArgoCD and Hashicorp Vault
...
- [MaxwellBo/maxwellbo.github.io](https://github.com/MaxwellBo/maxwellbo.github.io) - Personal website @ maxbo.me
- [Sn0wAlice/MatryRiska](https://github.com/Sn0wAlice/MatryRiska) - MatryRiska is an open source risk management tool that helps you to manage your risk management process.
- [betagouv/redirections](https://github.com/betagouv/redirections) - 
- [meichthys/foss_photo_libraries](https://github.com/meichthys/foss_photo_libraries) - Free and Open Source Photo Libraries
- [fchabouis/awesome-emojis](https://github.com/fchabouis/awesome-emojis) - A place to store awesome emojis from all over the web
...
- [mortalis13/Metronomix](https://github.com/mortalis13/Metronomix) - Sample based metronome
...
- [EmmanuelDemey/eco-index-audit](https://github.com/EmmanuelDemey/eco-index-audit) - 
- [etalab/programme10pourcent-site](https://github.com/etalab/programme10pourcent-site) - Site du programme 10% d'Etalab
...
- [WTTJ/dot_hackerpledge](https://github.com/WTTJ/dot_hackerpledge) - A public commitment from a company to provide a hacker-friendly workplace
...
- [DISIC/generate-pdf-example](https://github.com/DISIC/generate-pdf-example) - Java project used to demonstrate how to generate an accessible PDF with iText
- [ovh/pulumi-ovh](https://github.com/ovh/pulumi-ovh) - Pulumi provider for OVHcloud
...
- [softwarefactory-project/keycloak-github-ssh-key-attribute-mapper](https://github.com/softwarefactory-project/keycloak-github-ssh-key-attribute-mapper) - A custom Keycloak attribute mapper that fetches a user's SSH keys from the github REST API.
...
- [ClementGre/PDF4Teachers](https://github.com/ClementGre/PDF4Teachers) - PDF editing software for teachers, focused on productivity. PDF4Teachers keeps recorded previous annotations, and offers features like marking scale, PDF conversion, vectorial drawing...
...
- [ProgrammeVitam/mailextract](https://github.com/ProgrammeVitam/mailextract) - !!!! Version dépréciée car intégré désormais dans sedatools !!! Outil d'extraction de boite de messagerie (imap(s), thunderbird, outlook .pst, .msg...) générant une hiérarchies de fichiers corresponda
...
- [scarney81/pg-hstore](https://github.com/scarney81/pg-hstore) - A node package for serializing and deserializing JSON data to hstore format
- [simonw/prompts-js](https://github.com/simonw/prompts-js) - async alternatives to browser alert() and prompt() and confirm()
- [Scribouilli/scribouilli](https://github.com/Scribouilli/scribouilli) - 
...
- [anct-carto/france_services](https://github.com/anct-carto/france_services) - Annuaire cartographique France services
...
- [BYOJS/storage](https://github.com/BYOJS/storage) - Simple key-value storage API backed by various client storage mechanisms
...
- [bluwy/renoma](https://github.com/bluwy/renoma) - A recursive node_modules analyzer with opinionated package health checks
...
- [IGNF/cartes-ign-app](https://github.com/IGNF/cartes-ign-app) - Application mobile officielle de l'IGN, utilisant MapLibre GL JS et Capacitor
...
- [publicodes/model-template](https://github.com/publicodes/model-template) - Template de repo pour modèle Publicodes
...
- [zaproxy/action-full-scan](https://github.com/zaproxy/action-full-scan) - A GitHub Action for running the ZAP Full scan
- [BruceMacD/chatd](https://github.com/BruceMacD/chatd) - Chat with your documents using local AI
- [OpenSignLabs/OpenSign](https://github.com/OpenSignLabs/OpenSign) - 🔥 The free & Open Source DocuSign alternative
- [SocialGouv/appset-rancher-projects-plugin](https://github.com/SocialGouv/appset-rancher-projects-plugin) - 
...
- [gip-inclusion/pdf-generator](https://github.com/gip-inclusion/pdf-generator) - Simple Node.js service to generate a PDF from an URL via Puppeteer
...
- [betagouv/pad.numerique.gouv.fr](https://github.com/betagouv/pad.numerique.gouv.fr) - Pad numérique de l'état
...
- [drnoir/A-Frame_RoomCreator](https://github.com/drnoir/A-Frame_RoomCreator) - Component and basic map editor tool for A-Frame
- [dhoulb/multi-semantic-release](https://github.com/dhoulb/multi-semantic-release) - Proof of concept that wraps semantic-release to work with monorepos.
- [mikestead/lighthouse-batch](https://github.com/mikestead/lighthouse-batch) - Run Lighthouse analysis over multiple sites in a single command
- [GouvernementFR/dsfr-theme-tarteaucitron](https://github.com/GouvernementFR/dsfr-theme-tarteaucitron) - 
- [d4rekanguok/sanity-pizza](https://github.com/d4rekanguok/sanity-pizza) - 
...
- [manucaralmo/GlowCookies](https://github.com/manucaralmo/GlowCookies) - GlowCookies 🍪 - Powerful Cookie Consent Banner In JavaScript
...
- [maxlath/wikibase-edit](https://github.com/maxlath/wikibase-edit) - a lib to edit Wikibase from NodeJS
...
- [maxlath/hub](https://github.com/maxlath/hub) - Web hub based on Wikidata
...
- [cnumr/GreenIT-Analysis](https://github.com/cnumr/GreenIT-Analysis) - GreenIT-Analysis
...
- [mcnuttandrew/no-grammar-supplement](https://github.com/mcnuttandrew/no-grammar-supplement) - The supplementary material for the paper "No Grammar to Rule Them All: A Survey of Json-Style DSLs for Visualization"
- [gchq/CyberChef](https://github.com/gchq/CyberChef) - The Cyber Swiss Army Knife - a web app for encryption, encoding, compression and data analysis
- [GendarmerieNationale/dsfr-theme-tarteaucitron](https://github.com/GendarmerieNationale/dsfr-theme-tarteaucitron) - 
...
- [TomasHubelbauer/web-midi](https://github.com/TomasHubelbauer/web-midi) - OP-1 working with web MIDI
- [gljubojevic/akai-mpk-mini-editor](https://github.com/gljubojevic/akai-mpk-mini-editor) - Akai MPK Mini editor using Web MIDI api
- [janhapke/hasura-keycloak](https://github.com/janhapke/hasura-keycloak) - How to use Hasura with Keycloak
- [captcha-com/reactjs-captcha](https://github.com/captcha-com/reactjs-captcha) - BotDetect CAPTCHA React Component: Simple API integration for React 13/14/15/16+.
...
- [orbitdb-archive/orbit-db-store](https://github.com/orbitdb-archive/orbit-db-store) - Base class for orbit-db data stores
...
- [orbitdb-archive/orbit-db-identity-provider](https://github.com/orbitdb-archive/orbit-db-identity-provider) - Default identity provider for OrbitDB
...
- [datagouv/decoupage-administratif](https://github.com/datagouv/decoupage-administratif) - Données concernant le découpage administratif français, au format JSON
...
- [devthefuture-org/nctx](https://github.com/devthefuture-org/nctx) - NodeJS Contextual Dependency Injection using native async_hooks - IoC
- [jaredpalmer/tsdx](https://github.com/jaredpalmer/tsdx) - Zero-config CLI for TypeScript package development
- [kyndryl-open-source/hashi-vault-js](https://github.com/kyndryl-open-source/hashi-vault-js) - A node.js module to interact with the Hashicorp Vault API.
...
- [orbitdb-archive/orbit-db-io](https://github.com/orbitdb-archive/orbit-db-io) - Helper module used in OrbitDB to interface with storage layer
- [clinicjs/node-clinic](https://github.com/clinicjs/node-clinic) - Clinic.js diagnoses your Node.js performance issues
- [porsager/HashQL](https://github.com/porsager/HashQL) - 
...
- [projectdiscovery/nuclei-action](https://github.com/projectdiscovery/nuclei-action) - Vulnerability Scan with Nuclei
...
- [kode-team/codemirror-colorpicker](https://github.com/kode-team/codemirror-colorpicker) - colorpicker  with codemirror
...
- [orbitdb-archive/orbit-db-powergate-io](https://github.com/orbitdb-archive/orbit-db-powergate-io) - A bridge between OrbitDB and Powergate, which is itself a bridge between Filecoin and IPFS.
...
- [breejs/later](https://github.com/breejs/later) - *Maintained fork of Later.* A javascript library for defining recurring schedules and calculating future (or past) occurrences for them. Includes support for using English phrases and Cron schedules. 
...
- [munrocket/parallax-effect](https://github.com/munrocket/parallax-effect) - 💫 Parallax effect in javascript using face tracking. An immersive view in 3d with webcam.
...
- [orbitdb-archive/orbit-db-control-center](https://github.com/orbitdb-archive/orbit-db-control-center) - UI for managing OrbitDB databases
...
- [orbitdb/voyager](https://github.com/orbitdb/voyager) - Storage service for OrbitDB peer-to-peer databases
...
- [aviondb/aviondb-p2p-sync](https://github.com/aviondb/aviondb-p2p-sync) - A Todo App that can be synced p2p with multiple devices via QR Code
...
- [orbitdb-archive/field-manual](https://github.com/orbitdb-archive/field-manual) - The Offical User's Guide to OrbitDB
...
- [max-mapper/ndjson](https://github.com/max-mapper/ndjson) - streaming line delimited json parser + serializer
...
- [orbitdb-archive/example-orbitdb-todomvc](https://github.com/orbitdb-archive/example-orbitdb-todomvc) - TodoMVC with OrbitDB
...
- [renerpdev/knex-seeder](https://github.com/renerpdev/knex-seeder) - Knex tool for seeding massive amount of fake data into a database
...
- [intelligo-mn/neuro](https://github.com/intelligo-mn/neuro) - 🔮 Neuro.js is machine learning library for building AI assistants and chat-bots.
...
- [pmndrs/react-zdog](https://github.com/pmndrs/react-zdog) - ⚡️🐶 React bindings for zdog
...
- [livingdata-co/addok-geocode-stream](https://github.com/livingdata-co/addok-geocode-stream) - Node.js stream API for addok geocoder
...
- [jsumners/node-activedirectory](https://github.com/jsumners/node-activedirectory) - ActiveDirectory is an Node.js ldapjs client for authN (authentication) and authZ (authorization) for Microsoft Active Directory with range retrieval support for large Active Directory installations. O
...
- [Level/memdown](https://github.com/Level/memdown) - Superseded by memory-level. In-memory abstract-leveldown store for Node.js and browsers.
...
- [A9T9/RPA](https://github.com/A9T9/RPA) - Ui.Vision Open-Source RPA Software  with Computer Vision, OCR, Anthropic Computer Use. Selenium IDE  import/export.
...
- [Experience-Monks/360-image-viewer](https://github.com/Experience-Monks/360-image-viewer) - A standalone panorama viewer with WebGL
...
- [max-mapper/googleauth](https://github.com/max-mapper/googleauth) - Create and load persistent Google authentication tokens for command-line apps
...
- [Experience-Monks/audiobuffer-to-wav](https://github.com/Experience-Monks/audiobuffer-to-wav) - convert an AudioBuffer to .wav format
- [AriTheElk/uigradients](https://github.com/AriTheElk/uigradients) - Gradients-as-a-react-component™
...
- [sindresorhus/throttleit](https://github.com/sindresorhus/throttleit) - Throttle a function to limit its execution rate
...
- [max-mapper/electron-spawn](https://github.com/max-mapper/electron-spawn) - easy way to run code inside of a headless electron window from the CLI
...
- [Experience-Monks/ios-video-test](https://github.com/Experience-Monks/ios-video-test) - a test of inline iOS video playback
...
- [ikr/normalize-for-search](https://github.com/ikr/normalize-for-search) - Un-accents and un-umlauts characters in a string. Also preliminary converts the string to lower case. We use it for autocomplete: both for the matched strings -- on the server side, when indexing; and
...
- [apache/cordova-plugin-file-transfer](https://github.com/apache/cordova-plugin-file-transfer) - Apache Cordova File Transfer Plugin
...
- [c-frame/aframe-stereo-component](https://github.com/c-frame/aframe-stereo-component) - aframe.io component to enable separate eye rendering of objects, plus stereo video rendering (full 360 or half dome)
...
- [enzymejs/chai-enzyme](https://github.com/enzymejs/chai-enzyme) - Chai.js assertions and convenience functions for testing React Components with enzyme
...
- [zanuka/originator](https://github.com/zanuka/originator) - :skateboard: oldschool node module starter
...
- [bbc/html5-video-compositor](https://github.com/bbc/html5-video-compositor) - This is the BBC Research & Development UX Team's experimental shader based video composition engine for the browser. For new projects please consider using or new VideoContext library https://github.c
...
- [Experience-Monks/web-audio-player](https://github.com/Experience-Monks/web-audio-player) - a cross-browser WebAudio player
...
- [danthareja/node-google-apps-script](https://github.com/danthareja/node-google-apps-script) - [DEPRECATED - use clasp instead] The easiest way to develop Google Apps Script projects
...
- [rjcorwin/HTML5VideoInAndroidWebViewExample](https://github.com/rjcorwin/HTML5VideoInAndroidWebViewExample) - An example of using the &lt;video&gt; tag in an Android WebView.
...
- [max-mapper/mon-prebuilt](https://github.com/max-mapper/mon-prebuilt) - Install mon prebuilt binaries using npm
...
- [harthur/nomnom](https://github.com/harthur/nomnom) - Option parser for node with generated usage and commands
...
- [etodanik/ion-google-place](https://github.com/etodanik/ion-google-place) - Ionic directive for a location dropdown that utilizes google maps
...
- [spiralcrew-ou/JsonTreeDirective](https://github.com/spiralcrew-ou/JsonTreeDirective) - Simpel json-tree directive (AngularJS )
...
- [0x-r4bbit/angular-github-adapter](https://github.com/0x-r4bbit/angular-github-adapter) - Angular adapter module for github.js
...
- [0x-r4bbit/angular-component-seed](https://github.com/0x-r4bbit/angular-component-seed) - Seed for reusable Angular components
...
- [goker-dev/canvasResize](https://github.com/goker-dev/canvasResize) - Javascript Canvas Resize Plugin. It can work both with jQuery and Zepto. It's compatible with iOS6 and Android 2.3+
...
- [max-mapper/ViewKit](https://github.com/max-mapper/ViewKit) - UI library designed for WebKit/Mobile Safari/Android WebViews
...
- [xuijs/xui-plugins](https://github.com/xuijs/xui-plugins) - Extends XUI (a lightweight mobile javascript framework) with more features
...
- [ncr/node.ws.js](https://github.com/ncr/node.ws.js) - WARNING: NO LONGER ACTIVELY MAINTAINED (unless you want to help with a pull request :), use http://einaros.github.com/ws/ instead. Basic Web Sockets Server for node.js with similar interface to tcp.cr
...
- [draganbabic/uni-form](https://github.com/draganbabic/uni-form) - Uni-Form is a framework that standardizes form markup and styles it with CSS giving you two most widely used layout options to choose from. Anyone can get nice looking, well structured, highly customi
...
- [theSuriya/Gemma-SQL-Generator](https://github.com/theSuriya/Gemma-SQL-Generator) - Google Gemma Fine tune SQL Generator
...
- [lynnlangit/Hello-AWS-Data-Services](https://github.com/lynnlangit/Hello-AWS-Data-Services) - AWS Data/MLServices sample code & notes for my LinkedIn Learning courses
...
- [France-Travail/TradEmploi](https://github.com/France-Travail/TradEmploi) - TradEmploi
- [Algorithm-Arena/weekly-challenge-32-press-record](https://github.com/Algorithm-Arena/weekly-challenge-32-press-record) - 
...
- [elefevre/programmation-pour-les-enfants](https://github.com/elefevre/programmation-pour-les-enfants) - Des ressources pour initier ses enfants aux principes de la programmation.
...
- [abenoit/french-women-tech-speaker-organizer](https://github.com/abenoit/french-women-tech-speaker-organizer) - Liste de femmes conférencières et organisatrices de conférences tech. Soumettez une PR si vous souhaitez vous ajouter ou ajouter d'autres personnes !
...
- [Alezco/awesome-links](https://github.com/Alezco/awesome-links) - 🔗 A list of awesome links to articles, websites, videos, and more
...
- [directus-labs/awesome-directus](https://github.com/directus-labs/awesome-directus) - A curated list of awesome things related to Directus
...
- [bertrandkeller/74-best-pratices-GreenIT](https://github.com/bertrandkeller/74-best-pratices-GreenIT) - Référentiel de 74 bonnes pratiques Green IT - collectif greenit.fr
...
- [YannHY/cours](https://github.com/YannHY/cours) - Des cours écrits en Markdown afin d'en favoriser la diffusion et la collaboration
...
- [Experience-Monks/jam3-lesson-webgl-shader-intro](https://github.com/Experience-Monks/jam3-lesson-webgl-shader-intro) - A brief introduction to fragment shaders.
...
- [javamanrj/meetcha](https://github.com/javamanrj/meetcha) - We developed the Meetcha app to demonstrate how to use Sencha Touch 2 features in a real world application. We used the Sencha Touch’s built in MVC architecture, which we’ve found in this app and in g
...
- [matomo-org/plugin-CustomAlerts](https://github.com/matomo-org/plugin-CustomAlerts) - Alerts are a great way to get notified of changes on your website in Matomo.
...
- [regardscitoyens/nosdeputes.fr](https://github.com/regardscitoyens/nosdeputes.fr) - Repository of NosDéputés.fr : the french parliamentary monitoring website
...
- [premAI-io/premsql](https://github.com/premAI-io/premsql) - End-to-End Local-First Text-to-SQL Pipelines
- [andrewyng/aisuite](https://github.com/andrewyng/aisuite) - Simple, unified interface to multiple Generative AI providers
- [etalab-ia/albert-models](https://github.com/etalab-ia/albert-models) - Deployment a light and full OpenAI API for production with vLLM to support /v1/embeddings with all embeddings models.
- [pappitti/famlx](https://github.com/pappitti/famlx) - llm playground built on MLX
- [huggingface/smollm](https://github.com/huggingface/smollm) - Everything about the SmolLM & SmolLM2 family of models
- [etalab-ia/albert-api](https://github.com/etalab-ia/albert-api) - 
- [matthewjgunton/mlx_json_lora](https://github.com/matthewjgunton/mlx_json_lora) - 
...
- [louisbrulenaudet/lemone-embed](https://github.com/louisbrulenaudet/lemone-embed) - All-in-one repo for the Lemone-embed project, a series of fine-tuned embedding models for Tax retrieval augmented generation (RAG).
...
- [morgangiraud/text-to-sql-proto](https://github.com/morgangiraud/text-to-sql-proto) - A text-to-SQL prototype on the northwind sqlite dataset
...
- [replicate/flux-fine-tuner](https://github.com/replicate/flux-fine-tuner) - Cog wrapper for ostris/ai-toolkit + post-finetuning cog inference for flux models
- [fishaudio/fish-speech](https://github.com/fishaudio/fish-speech) - SOTA Open Source TTS
- [infobyte/faraday](https://github.com/infobyte/faraday) - Open Source Vulnerability Management Platform
- [PanagiotisIatrou/Photo-Mosaic-Maker](https://github.com/PanagiotisIatrou/Photo-Mosaic-Maker) - A python command line tool for creating photo mosaics effortlessly
...
- [taylorai/mlx_embedding_models](https://github.com/taylorai/mlx_embedding_models) - run embeddings in MLX
...
- [numerique-gouv/meet](https://github.com/numerique-gouv/meet) - 
- [stanfordnlp/dspy](https://github.com/stanfordnlp/dspy) - DSPy: The framework for programming—not prompting—language models
- [adefossez/seewav](https://github.com/adefossez/seewav) - Audio waveform visualisation, converts any audio to a nice video
...
- [Polyconseil/xlsx_streaming](https://github.com/Polyconseil/xlsx_streaming) - Stream data as xlsx
...
- [CentraleSupelec/aristote-dispatcher](https://github.com/CentraleSupelec/aristote-dispatcher) - 🔀 Deployement of LLM at a large scale using VLLM server for inference
...
- [dgarnitz/vectorflow](https://github.com/dgarnitz/vectorflow) - VectorFlow is a high volume vector embedding pipeline that ingests raw data, transforms it into vectors and writes it to a vector DB of your choice.
...
- [betagouv/clamav-service](https://github.com/betagouv/clamav-service) - A minimal ClamD REST interface
...
- [numerique-gouv/sites-faciles](https://github.com/numerique-gouv/sites-faciles) - Gestionnaire de contenu permettant de créer et gérer un site internet basé sur le Système de design de l'État, accessible et responsive
...
- [GitGuardian/ggcanary](https://github.com/GitGuardian/ggcanary) - GitGuardian Canary Tokens
...
- [wetneb/openrefine-wikibase](https://github.com/wetneb/openrefine-wikibase) - This repository has migrated to:
...
- [upgini/upgini](https://github.com/upgini/upgini) - Data search & enrichment library for Machine Learning → Easily find and add relevant features to your ML & AI pipeline from hundreds of public and premium external data sources, including open & comme
- [GhettoBastler/gml2mt](https://github.com/GhettoBastler/gml2mt) - Draw GML tags on a Minitel
- [pylover/adia](https://github.com/pylover/adia) - ASCII diagram language & generator for UML sequence diagram.
...
- [josephernest/SamplerBox](https://github.com/josephernest/SamplerBox) - SamplerBox is a sampler musical instrument based on RaspberryPi.
- [mingrammer/diagrams](https://github.com/mingrammer/diagrams) - :art: Diagram as Code for prototyping cloud system architectures
- [rheinwerk-verlag/pganonymize](https://github.com/rheinwerk-verlag/pganonymize) - A commandline tool for anonymizing PostgreSQL databases
...
- [thisisbhavin/graphicalForest](https://github.com/thisisbhavin/graphicalForest) - Using the adjacency matrix and random forest get the Name, Address, Items, Prices, Grand total from all kind of invoices.
...
- [aleph-im/pyaleph](https://github.com/aleph-im/pyaleph) - Next generation network of decentralized big data applications. Current connected chains: Ethereum, Solana, Polkadot/Substrate, Cosmos-SDK, NULS.
...
- [datagouv/csv-detective](https://github.com/datagouv/csv-detective) - CSV inspection
...
- [lanl/pyxDamerauLevenshtein](https://github.com/lanl/pyxDamerauLevenshtein) - pyxDamerauLevenshtein implements the Damerau-Levenshtein (DL) edit distance algorithm for Python in Cython for high performance.
...
- [tiangolo/meinheld-gunicorn-docker](https://github.com/tiangolo/meinheld-gunicorn-docker) - Docker image with Meinheld managed by Gunicorn for high-performance WSGI (Flask, Django, etc) web applications in Python with performance auto-tuning.
...
- [Zigazou/PyMinitel](https://github.com/Zigazou/PyMinitel) - PyMinitel est une bibliothèque Python permettant de pilor un Minitel depuis un PC sous Linux. Pour cela, la bibliothèque PySerial est nécessaire car elle est utilisée pour dialoguer avec le Minitel, e
...
- [russian-developer/Flask-memcache-session](https://github.com/russian-developer/Flask-memcache-session) - Adds the ability to use as a storage memcache
...
- [cpesr/wikidataESR](https://github.com/cpesr/wikidataESR) - Une exploitation de WikiData pour reconstruire les relations entre les établissements de l'ESR.
...
- [freesteph/paperasse](https://github.com/freesteph/paperasse) - An official French-administration-document producing tool
...
- [dottxt-ai/outlines-core](https://github.com/dottxt-ai/outlines-core) - Structured generation in Rust
...
- [demarches-simplifiees/ds_proxy](https://github.com/demarches-simplifiees/ds_proxy) - Proxy de chiffrement utilisé sur demarches-simplifiees
...
- [sneko/dsfr-connect](https://github.com/sneko/dsfr-connect) - This library themes your favorite UI framework to look like the official DSFR as much as possible
- [Meeovi/Collaborrate](https://github.com/Meeovi/Collaborrate) - Powerful headless customer relationship framework that can be used to build relations with customers, create and manage projects, lists, tickets, and more.
...
- [evenfurther/AusweisBot](https://github.com/evenfurther/AusweisBot) - Telegram bot to generate self-authorizations for moving around during covid-19 pandemic in France
...
- [tripsolutions/postgres-containers](https://github.com/tripsolutions/postgres-containers) - Operand images for CloudNativePG with extensions
- [JamieMagee/vulnerability-git-hooks](https://github.com/JamieMagee/vulnerability-git-hooks) - git hooks to prevent committing vulnerable dependencies
...
- [gridsound/daw](https://github.com/gridsound/daw) - GridSound (1.47.2) wants to be a free online digital audio workstation following the new WebAudio API 🎛🎹🎵✨ -- If you can, please sponsor us a little on our Patreon ❤️
...
- [delatteAL/ActionPublique1949](https://github.com/delatteAL/ActionPublique1949) - 
...
- [mzbac/flux.swift.cli](https://github.com/mzbac/flux.swift.cli) - CLI tool for text to image generation using the FLUX.1 model.
...
- [Paljasn/Maths](https://github.com/Paljasn/Maths) - 
...
- [tchapgouv/tchap-bot-mte](https://github.com/tchapgouv/tchap-bot-mte) - 
- [incubateur-ademe/next-auth-espace-membre-provider](https://github.com/incubateur-ademe/next-auth-espace-membre-provider) - NextAuth.js provider pour l'Espace Membre BetaGouv
- [bluesky-social/feed-generator](https://github.com/bluesky-social/feed-generator) - ATProto Feed Generator Starter Kit
- [bastiensun/pg-mermaid](https://github.com/bastiensun/pg-mermaid) - 🐘 Mermaid diagram generator for PostgreSQL database schema
- [datsfilipe/web-ascii-theater](https://github.com/datsfilipe/web-ascii-theater) - Package that exports a component that can be used to play ascii animations inside a React.js application.
...
- [SocialGouv/aes-gcm-rsa-oaep](https://github.com/SocialGouv/aes-gcm-rsa-oaep) - Kubeseal aes-gcm-rsa-oaep encryption implementaton in TypeScript
- [garronej/tsafe](https://github.com/garronej/tsafe) - 🔩 The missing TypeScript utils
- [restackio/examples-typescript](https://github.com/restackio/examples-typescript) - Restack AI examples for TypeScript
...
- [vercel-labs/natural-language-postgres](https://github.com/vercel-labs/natural-language-postgres) - 
- [lsagetlethias/charon](https://github.com/lsagetlethias/charon) - Charon is a dynamic OAuth2 routing application designed to facilitate authentication through different OIDC providers while preserving the flexibility of changing callback URLs.
...
- [mckaywrigley/buildware-ai](https://github.com/mckaywrigley/buildware-ai) - An experimental AI coding tool.
...
- [cfahlgren1/hf-data-explorer](https://github.com/cfahlgren1/hf-data-explorer) - Chrome Extension for exploring Hugging Face datasets 🔎
...
- [Jevon617/unplugin-svg-component](https://github.com/Jevon617/unplugin-svg-component) - generate a vue/react component through svg files, supporting svg file HMR, Tree-shaking, SSR and TS hint.
...
- [pgmanutd/node-talisman](https://github.com/pgmanutd/node-talisman) - 👌 By hooking into the pre-push hook provided by Git, Talisman validates the outgoing changeset for things that look suspicious - such as authorization tokens and private keys.
...
- [keycloakify/oidc-spa](https://github.com/keycloakify/oidc-spa) - Openid connect client for Single Page Applications
...
- [tchak/geojson2png](https://github.com/tchak/geojson2png) - A simple server to render geojson as png files
...
- [njourdane/jaffle](https://github.com/njourdane/jaffle) - An hybrid yaml/node editor for Tidal Cycles, based on Strudel.
...
- [martijnversluis/ChordSheetJS](https://github.com/martijnversluis/ChordSheetJS) - A JavaScript library for parsing and formatting chords and chord sheets
...
- [publicodes/language-server](https://github.com/publicodes/language-server) - LS and VSCode client for Publicodes
...
- [inclusion-numerique/mediature](https://github.com/inclusion-numerique/mediature) - A french national platform allowing citizens to request mediation for administrative issues
...
- [47ng/sceau](https://github.com/47ng/sceau) - Code signing for NPM packages
- [argos-ci/argos](https://github.com/argos-ci/argos) - Elinate visual bugs & regressions. The open source visual testing platform for modern engineering teams.
...
- [garronej/i18nifty](https://github.com/garronej/i18nifty) - 🌎 Type safe React i18n library
...
- [openfun/verna](https://github.com/openfun/verna) - 🏗️ An extensible form builder based on React JSON Schema Form.
...
- [mbalabash/sdc-check](https://github.com/mbalabash/sdc-check) - Small tool to inform you about potential risks in project dependencies list
...
- [garronej/vite-envs](https://github.com/garronej/vite-envs) - ⚙️  Env var in Vite at container startup
...
- [InseeFrLab/onyxia](https://github.com/InseeFrLab/onyxia) - 🔬 Data science environment for k8s
...
- [InseeFrLab/onyxia-ui](https://github.com/InseeFrLab/onyxia-ui) - 🌓  Onyxia UI toolkit
...
- [polyrainbow/neno](https://github.com/polyrainbow/neno) - NENO is a note-taking app that helps you create your personal knowledge graph.
...
- [j0lvera/next-csrf](https://github.com/j0lvera/next-csrf) - CSRF mitigation for Next.js
...
- [alan345/TER](https://github.com/alan345/TER) - Fullstack Boilerplate with tRPC, Express and React.
...
- [bhollis/aruco-marker](https://github.com/bhollis/aruco-marker) - JavaScript library and custom HTML element for generating Aruco marker images
...
- [googleapis/nodejs-datastore-kvstore](https://github.com/googleapis/nodejs-datastore-kvstore) - **THIS REPOSITORY AND PACKAGE WILL BE DEPRECATED IN JULY 2024**  Use @google-cloud/datastore as a Key/Value store.
...
- [IAMSDR/MyAuthenticator](https://github.com/IAMSDR/MyAuthenticator) - A serverless web application that generates TOTP and HOTP codes, enabling robust two-factor authentication (2FA) directly within your browser. Powered by Nuxt 3, NuxtHub, Cloudflare Pages, D1 Database
- [flobutbut/universTimeline](https://github.com/flobutbut/universTimeline) - 
- [GouvernementFR/dsfr-chart](https://github.com/GouvernementFR/dsfr-chart) - 🇫🇷  Data visualization library supported by french government's design system (Système de Design de l'État)
- [contitri/dsfr-chart](https://github.com/contitri/dsfr-chart) - 
...
- [DISIC/Ara](https://github.com/DISIC/Ara) - Faire des audits de conformité au RGAA, partager les rapports et la déclaration d’accessibilité.
- [benc-uk/kubeview](https://github.com/benc-uk/kubeview) - Kubernetes cluster visualiser and graphical explorer
- [datagouv/explore.data.gouv.fr](https://github.com/datagouv/explore.data.gouv.fr) - A simple frontend for https://github.com/etalab/csvapi
...
- [assurance-maladie-digital/design-system](https://github.com/assurance-maladie-digital/design-system) - 📦 Un Design System pour l’Assurance Maladie
